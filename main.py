...
if "playlist_data" not in st.session_state:
    st.session_state.playlist_data = {
        "우울할 때": [
            "백예린 - Square (2017)", "밍기뉴 - 오래오래, 우리", "IU - Love Poem", "정승환 - 눈사람"
        ],
        "신날 때": [
            "방탄소년단 - Dynamite", "NewJeans - Super Shy", "Bruno Mars - Uptown Funk"
        ],
        "공부할 때": [
            "Lofi Girl - Study Beats", "카더가든 - 명동콜링", "윤하 - 사건의 지평선"
        ],
        "산책할 때": [
            "잔나비 - 주저하는 연인들을 위해", "볼빨간사춘기 - 여행", "Paul Kim - 모든 날, 모든 순간",
            "볼빨간사춘기 - 나만 봄", "악동뮤지션 - 시간과 낙엽", "10cm - 쓰담쓰담"
        ],
        "샤워할 때": [
            "LUCY - 아지랑이", "볼빨간사춘기 - 나의 사춘기에게", "안녕 - 너의 번호를 누르고"
        ],
        "운동할 때": [
            "Stray Kids - S-Class", "ZICO - 아무노래", "BLACKPINK - Pink Venom",
            "Eminem - Lose Yourself", "방탄소년단 - Fire", "SEVENTEEN - HOT"
        ],
        "독서할 때": [
            "잔나비 - 주저하는 연인들을 위해", "볼빨간사춘기 - 여행"
        ],
        "잠자기 전": [
            "폴킴 - 너를 만나", "백예린 - Bye bye my blue", "정승환 - 이 바보야",
            "적재 - 나랑 같이 걸을래", "로이킴 - 그때 헤어지면 돼"
        ],
        "비올 때": [
            "Heize - 비도 오고 그래서", "적재 - 나랑 같이 걸을래", "김광석 - 어느 60대 노부부 이야기",
            "아이유 - Love wins all", "폴킴 - 모든 날, 모든 순간"
        ],
